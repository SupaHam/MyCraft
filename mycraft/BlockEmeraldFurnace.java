...
public class BlockEmeraldFurnace extends BlockContainer
{
    /**
    ...
    protected BlockEmeraldFurnace(int par1, int par2, boolean par3)
    {
        super(par1, par2, Material.rock);
        this.isActive = par3;
        this.blockIndexInTexture = 2;
        this.setCreativeTab(CreativeTabs.tabBlock);
        this.setBlockName("Emerald Furance");
    ...
    {
        return MyCraft.blockEmeraldFurnaceIdle.blockID;
    }
    ...
    public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
        ...
        if (par0)
        {
            par1World.setBlockWithNotify(par2, par3, par4, MyCraft.blockEmeraldFurnaceActive.blockID);
        }
        else
        {
            par1World.setBlockWithNotify(par2, par3, par4, MyCraft.blockEmeraldFurnaceIdle.blockID);
        }
