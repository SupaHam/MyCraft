...
public class ItemLemonFood extends ItemFood{
	...
	public ItemLemonFood(int par1, int par2, float par3, boolean par4) {
    ...
    public ItemLemonFood(int par1, int par2, boolean par3) {
     ...
     */
    public ItemLemonFood setPotionEffect(int par1, int par2, int par3, float par4)
    {
        this.potionId = par1;
     ...
     */
    public ItemLemonFood setAlwaysEdible()
    {
